...
use crate::{
    config::Config,
    handle,
    template::{RatticeTemplate, WATERMARK},
};

pub fn generate_static_pages(config: Arc<Config>, add_watermark: bool) -> Result<()> {
...
pub fn remove_static_pages(check_watermark: bool) -> Result<()> {
